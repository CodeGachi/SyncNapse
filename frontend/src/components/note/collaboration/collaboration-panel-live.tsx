...
import { QAPanelLive } from "./qa-panel-live";
import { PollPanelLive } from "./poll-panel-live";
import { Users, MessageCircle, BarChart3 } from "lucide-react";

interface CollaborationPanelLiveProps {
  userId: string;
  userName: string;
  noteId: string;
  isEducator?: boolean;
...
export function CollaborationPanelLive({
  userId,
  userName,
  noteId,
  isEducator = false,
  className = "",
}: CollaborationPanelLiveProps) {
