...
export function NotePanel({ isOpen }: NotePanelProps) {
  ...
  return (
    <div className="w-full h-full bg-[#2f2f2f] border-2 border-[#b9b9b9] rounded-2xl p-6 flex flex-col">
      {/* 페이지 정보 헤더 */}
      <div className="flex-shrink-0 mb-4 pb-2 border-b border-[#444444] flex items-center justify-between">
        <h3 className="text-white font-semibold text-sm">Page {currentPage} Notes</h3>
        <div className="text-gray-400 text-xs">{blocks.length} 블록</div>
      </div>
